...
export const translations = {
  tr: {
    ...
    appearance: "Görünüm",
    behavior: "Davranış",
    historySettings: "Geçmiş",
    shortcutSettings: "Kısayollar",
    maintenance: "Bakım",
    screenOcr: "Ekran OCR",
    ocrImage: "Görselde OCR yap",
    ocrPreparing: "Ekran OCR hazırlanıyor…",
    ocrReading: "OCR metni okunuyor…",
    ocrCopied: "OCR sonucu panoya kopyalandı",
    ocrCancelled: "Ekran OCR iptal edildi",
    ocrShortcutHint: "Ekran görüntüsünde alan seçip metni doğrudan geçmişe ve panoya aktarır.",
    ocrShortcutSuperHelp: "Super kısayolları GNOME üzerinden otomatik ayarlanır.",
    clear: "Temizle",
    ...
    shortcutWinVButton: "Super + V",
    shortcutSuperHelp: "Super dahil tüm kısayolları burada kaydedebilirsin; GNOME Özel Kısayollar'a ayrıca ekleme.",
    ...
    updateNone: "ClipNest güncel.",
    updateFound: "Güncelleme bulundu",
    updateInstallConfirm: "İndirip kurmak ister misin?",
    updateInstallAction: "İndir ve Kur",
  ...
  en: {
    ...
    ocrImage: "Run OCR on image",
    ocrPreparing: "Preparing screen OCR…",
    ocrReading: "Reading OCR text…",
    ocrCopied: "OCR result copied to clipboard",
    ocrCancelled: "Screen OCR cancelled",
    ocrShortcutHint: "Select an area on screen and send the text directly to history and clipboard.",
    ocrShortcutSuperHelp: "Super shortcuts are configured through GNOME automatically.",
    clear: "Clear",
    ...
    shortcutWinVButton: "Super + V",
    shortcutSuperHelp: "Record shortcuts here, including Super; do not add the same shortcut again in GNOME Custom Shortcuts.",
    ...
    updateNone: "ClipNest is up to date.",
    updateFound: "Update found",
    updateInstallConfirm: "Do you want to download and install it?",
